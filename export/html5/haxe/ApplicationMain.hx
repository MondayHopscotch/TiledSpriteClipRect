...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FlixelTest", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("FlixelTest", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "FlixelTest";
		app.meta["name"] = "FlixelTest";
